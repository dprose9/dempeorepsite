function tictactoeFunc() {
	document.getElementById("tictactoeid").innerHTML = `<body>
									<p style="display:flex; text-align:center;">
										...
										<img src="/games/tictactoe/tttVs.png" alt=":)" width="50%" height="50%">
										<img src="/games/tictactoe/tttBh.png" alt=":)" width="50%" height="50%">
										<img src="/games/tictactoe/tttBs.png" alt=":)" width="50%" height="50%"><br>
										
										<img src="/games/tictactoe/tttBv.png" alt=":)" width="50%" height="50%">
										<img src="/games/tictactoe/tttB.png" alt="?" width="50%" height="50%">
										<img src="/games/tictactoe/tttV.png" alt=":)" width="50%" height="50%">
										<img src="/games/tictactoe/tttB.png" alt="?" width="50%" height="50%">
										<img src="/games/tictactoe/tttV.png" alt=":)" width="50%" height="50%">
										<img src="/games/tictactoe/tttB.png" alt="?" width="50%" height="50%">
										<img src="/games/tictactoe/tttBv.png" alt=":)" width="50%" height="50%"><br>
										
										<img src="/games/tictactoe/tttHs.png" alt=":)" width="50%" height="50%">
										<img src="/games/tictactoe/tttH.png" alt=":)" width="50%" height="50%">
										<img src="/games/tictactoe/tttC.png" alt=":)" width="50%" height="50%">
										<img src="/games/tictactoe/tttH.png" alt=":)" width="50%" height="50%">
										<img src="/games/tictactoe/tttC.png" alt=":)" width="50%" height="50%">
										<img src="/games/tictactoe/tttH.png" alt=":)" width="50%" height="50%">
